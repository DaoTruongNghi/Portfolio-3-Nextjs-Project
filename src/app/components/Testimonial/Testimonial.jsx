...
function Testimonial() {
  ...
  return (
    <div id="testimonial">
      <div
        className="max-h-[450px] py-12 lg:px-12 md:px-5 px-3 rounded-lg"
        style={{
          backgroundImage:
        ...
        <div className="lg:container mx-auto px-0 sm:max-h-[350px]">
          <div className="text-center">
            <h2 className="font-extrabold text-5xl mb-6 text-[#48AEDD]">
              What my Custommers Says About Me
            </h2>
            <p
              className={`max-w-2xl font-[200] font-recoetaBold mx-auto mb-12 lg:mb-24`}
            >
          ...
          <Slider {...settings} className="cursor-all-scroll">
            <div className="flex pl-0">
              <div
                className="w-[100%] sm:w-[95%] pl-20 m-auto bg-green-500 rounded-2xl p-4 lg:-6 min-h-[250px]"
                style={{
                  backgroundImage:
                    "linear-gradient(5deg, #48AEDE 0 10%, white 0% 90%)",
                }}
              >
                <div className="flex">
                  ...
                  <div className="flex flex-col gap-x-4 md:flex-col">
                    <div className="font-medium text-base">Daisy Papo</div>
                    <div
                      className={`font-[300] ${hind.className} text-[#48AEDD]`}
                    >
                      Youtube Student
                    </div>
                    <p
