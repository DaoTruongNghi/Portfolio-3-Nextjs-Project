    ...
    <>
      <div className="relative">
        <div
          ...
          } cursor-pointer fixed w-14 h-14 lg:w-24 lg:h-24 
          bg-[#48AFDE] flex justify-center items-center 
          rounded-br-3xl`}
        >
          <div
            onClick={() => {
      ...
      >
        <div className="relative">
          <div
            className="z-20 absolute transform-gpu eas-in-out duration-500 transition-all 
          scale-100 -translate-y-none opacity-100 bg-[#223740] bg-opacity-95 w-full h-screen 
          ...
          >
            <nav className="text-white font-recoletaBold text-center text-4xl lg:text-4xl 2xl:text-6xl uppercase">
              ...
              <section className="mt-14 sm:mt-12 lg:mt-14 text-center relative sm:absolute lg:relative sm:right-0 sm:top-0 lg:right-0 h-auto sm:h-full lg:h-auto">
                <h3 className="block sm:hidden lg:block font-bold text-[#48AFDE] text-2x uppercase mb-5">
                  Follow Me Around
                </h3>
                <div className="flex flex-row justify-center sm:flex-col lg:flex-row">
                  ...
                  <a
                    href="https://www.instagram.com/truonghi.photographer/"
                    className="text-gray-300 hover:text-white transition-colors duration-3000"
                  >
                    <svg
                      stroke="currentColor"
                  ...
                  <a
                    href="https://github.com/DaoTruongNghi?tab=repositories"
                    className="text-gray-300 hover:text-white transition-colors duration-3000"
                  >
                    <svg
                      stroke="currentColor"
                  ...
                  <a
                    href="https://www.facebook.com/truonghi812"
                    className="text-gray-300 hover:text-white transition-colors duration-3000"
                  >
                    <svg
                      stroke="currentColor"
